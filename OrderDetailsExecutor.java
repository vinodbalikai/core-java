class OrderDetailsExecutor{
	public static void main(String[] order){
		...
		System.out.println("The Order Name is: "+orderDetails.getOrderName());
		...
		System.out.println("The Order Amount is: "+orderDetails.getOrderAmount());
		
		orderDetails.setOrderAddress("Bangalore");
		System.out.println("The Order Address is: "+orderDetails.getOrderAddress());
		
		orderDetails.setOrderStatus("Delivered");
		System.out.println("The Order Status is: "+orderDetails.getOrderStatus());
		...
		System.out.println("The Order Name is: "+orderDetails1.getOrderName());
		...
		System.out.println("The Order Amount is: "+orderDetails1.getOrderAmount());

		orderDetails1.setOrderAddress("Chennai");
		System.out.println("The Order Address is: "+orderDetails1.getOrderAddress());

		orderDetails1.setOrderStatus("Shipped");
		...
		System.out.println("The Order Name is: "+orderDetails2.getOrderName());
		...
		System.out.println("The Order Amount is: "+orderDetails2.getOrderAmount());

		orderDetails2.setOrderAddress("Mumbai");
		System.out.println("The Order Address is: "+orderDetails2.getOrderAddress());

		orderDetails2.setOrderStatus("Packed");
		...
		System.out.println("The Order Name is: "+orderDetails3.getOrderName());
		...
		System.out.println("The Order Amount is: "+orderDetails3.getOrderAmount());

		orderDetails3.setOrderAddress("Delhi");
		System.out.println("The Order Address is: "+orderDetails3.getOrderAddress());

		orderDetails3.setOrderStatus("Delivered");
		...
		System.out.println("The Order Name is: "+orderDetails4.getOrderName());
		...
		System.out.println("The Order Amount is: "+orderDetails4.getOrderAmount());

		orderDetails4.setOrderAddress("Pune");
		System.out.println("The Order Address is: "+orderDetails4.getOrderAddress());

		orderDetails4.setOrderStatus("Shipped");
		...
		System.out.println("The Order Name is: "+orderDetails5.getOrderName());
		...
		System.out.println("The Order Amount is: "+orderDetails5.getOrderAmount());

		orderDetails5.setOrderAddress("Hyderabad");
		System.out.println("The Order Address is: "+orderDetails5.getOrderAddress());

		orderDetails5.setOrderStatus("Pending");
