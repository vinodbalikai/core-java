class SubscriptionDetailsExecutor{
	public static void main(String[] sub){
		...
		System.out.println("The Plan Type is: "+subscriptionDetails.getPlanType());
		...
		System.out.println("The User Email is: "+subscriptionDetails.getUserEmail());
		
		subscriptionDetails.setStatus("Active");
		System.out.println("The Status is: "+subscriptionDetails.getStatus());
		...
		System.out.println("The Plan Type is: "+subscriptionDetails1.getPlanType());
		...
		System.out.println("The User Email is: "+subscriptionDetails1.getUserEmail());
		
		subscriptionDetails1.setStatus("Active");
		System.out.println("The Status is: "+subscriptionDetails1.getStatus());
		...
		System.out.println("The Plan Type is: "+subscriptionDetails2.getPlanType());
		...
		System.out.println("The User Email is: "+subscriptionDetails2.getUserEmail());
		
		subscriptionDetails2.setStatus("Inactive");
		System.out.println("The Status is: "+subscriptionDetails2.getStatus());
		...
		System.out.println("The Plan Type is: "+subscriptionDetails3.getPlanType());
		...
		System.out.println("The User Email is: "+subscriptionDetails3.getUserEmail());
		
		subscriptionDetails3.setStatus("Active");
		System.out.println("The Status is: "+subscriptionDetails3.getStatus());
		
		
		SubscriptionDetails subscriptionDetails4=new SubscriptionDetails();
		...
		System.out.println("The Plan Type is: "+subscriptionDetails4.getPlanType());
		...
		System.out.println("The User Email is: "+subscriptionDetails4.getUserEmail());
		
		subscriptionDetails4.setStatus("Pending");
		System.out.println("The Status is: "+subscriptionDetails4.getStatus());
