class UserManualExecutor{
	public static void main(String[] manual){
		...
		System.out.println("The Product Name is: "+userManual.getProductName());
		...
		System.out.println("The Publisher is: "+userManual.getPublisher());
		
		
		UserManual userManual1=new UserManual();
		...
		System.out.println("The Product Name is: "+userManual1.getProductName());
		...
		System.out.println("The Publisher is: "+userManual1.getPublisher());
		...
		System.out.println("The Product Name is: "+userManual2.getProductName());
		...
		System.out.println("The Version is: "+userManual2.getVersion());
		
		userManual2.setPublisher("Samsung");
		System.out.println("The Publisher is: "+userManual2.getPublisher());
		...
		System.out.println("The Product Name is: "+userManual3.getProductName());
		...
		System.out.println("The Publisher is: "+userManual3.getPublisher());
		...
		System.out.println("The Product Name is: "+userManual4.getProductName());
		...
		System.out.println("The Version is: "+userManual4.getVersion());
		
		userManual4.setPublisher("Daikin");
		System.out.println("The Publisher is: "+userManual4.getPublisher());
